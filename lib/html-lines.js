...
var LINES = (function () {
    ...
    var draw = function (line) {
        ...
        line.el.style.transform = 'translate(' + (line.anchor1.offset.left + strokeOffsetLeft) + 'px, ' + (line.anchor1.offset.top - strokeOffsetTop) + 'px) rotate(' + (angle * 180 / Math.PI) + 'deg)';
