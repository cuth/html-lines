...
var LINES = (function () {
    ...
    var draw = function (line) {
        ...
        var strokeOffsetLeft = Math.sin(angle) * line.stroke / 2;
        var strokeOffsetTop = Math.cos(angle) * line.stroke / 2;

        var translateX = line.anchor1.offset.left + strokeOffsetLeft;
        var translateY = line.anchor1.offset.top - strokeOffsetTop;

        var angleDegress = angle * 180 / Math.PI;

        line.el.style.transform = 'translate(' + translateX + 'px, ' + translateY + 'px) rotate(' + angleDegress + 'deg)';
    ...
    var Line = function (anchor1, anchor2, properties) {
        ...
        this.stroke = properties.stroke || 1;
